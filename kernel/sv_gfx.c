...
void sv_draw_glyph(int px, int py, char ch, u8 fg, u8 bg) {
    static const u8 empty[5] = {0,0,0,0,0};
    ...
    static const u8 dot[5] = {0,0,0,0x60,0x60};
    static const u8 colon[5] = {0,0x36,0x36,0,0};
    static const u8 dash[5] = {0x08,0x08,0x08,0x08,0x08};
    static const u8 gt[5] = {0x41,0x22,0x14,0x08,0};
    static const u8 underscore[5] = {0x40,0x40,0x40,0x40,0x40};
    static const u8 plus[5] = {0x08,0x08,0x7F,0x08,0x08};
    static const u8 mul[5] = {0x22,0x14,0x08,0x14,0x22};
    static const u8 div_slash[5] = {0x20,0x10,0x08,0x04,0x02};
    static const u8 eq[5] = {0x14,0x14,0x14,0x14,0x14};
    static const u8 letter_C[5] = {0x3E,0x41,0x41,0x41,0x22};
    const u8 *g;
    int col, row;
    ...
    for (col = 0; col < 5; col++) {
        ...
        for (row = 0; row < 7; row++) {
            u8 on = (u8)((bits >> row) & 1);
            vga13_put_pixel(px + col, py + row, on ? fg : bg);
        }
    }
}
